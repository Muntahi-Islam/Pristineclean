...
export function Hero() {
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center overflow-hidden bg-warm-50">
      {/* Background accents */}
      <div className="absolute top-0 right-0 w-[40%] h-full bg-gradient-to-bl from-blue-600/8 to-transparent" />
      <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-blue-600/5 rounded-full blur-3xl" />
      ...
      <div className="relative container-main pt-28 md:pt-36 pb-16 md:pb-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 bg-blue-600/10 text-blue-600 px-4 py-2 text-sm font-medium mb-6">
              <Sparkles size={16} />
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold text-navy-900 leading-[1.05] tracking-tight">
              Your Space,{" "}
              <span className="text-blue-600">Immaculately</span>
              <br />
              Maintained
            </h1>

            <p className="mt-5 text-base sm:text-lg text-navy-500 leading-relaxed max-w-lg">
              Experience the difference of professional cleaning. We don&apos;t just clean — we restore, refresh, and revitalize your environment with meticulous attention to detail.
            </p>
          ...
          <div className="relative lg:justify-self-end w-full max-w-lg mx-auto lg:mx-0">
            {/* Main visual card */}
            <div className="relative aspect-[4/3] w-full bg-gradient-to-br from-blue-50 via-white to-blue-100 border-2 border-blue-200/50 shadow-2xl shadow-blue-600/10 overflow-hidden">
              {/* Decorative circles */}
              <div className="absolute -top-16 -right-16 w-48 h-48 bg-blue-600/10 rounded-full blur-xl" />
              ...
              <div className="absolute inset-0 p-6 sm:p-8 flex flex-col">
                {/* Window */}
                <div className="relative w-full flex-1 max-h-[55%] bg-gradient-to-b from-blue-100/60 to-blue-50/30 border-2 border-blue-200/50 rounded-sm overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-full h-full relative">
                      {/* Sky gradient through window */}
                      <div className="absolute inset-0 bg-gradient-to-b from-blue-200/40 to-white/60" />
                      {/* Window cross */}
                      <div className="absolute inset-0 flex">
                        <div className="w-1/2 h-full border-r border-blue-200/50" />
                      </div>
                      <div className="absolute inset-0 flex flex-col">
                        <div className="h-1/2 border-b border-blue-200/50" />
                      </div>
                      {/* Sun */}
                ...
                {/* Floor area with furniture outlines */}
              ...
              {/* Badge */}
              <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-sm border border-blue-200/50 px-2.5 py-1.5 shadow-sm flex items-center gap-1.5">
                <Sparkles size={12} className="text-blue-600" />
                <span className="text-[11px] font-semibold text-navy-900">Premium</span>
              </div>

              {/* Rating badge */}
              <div className="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm border border-blue-200/50 px-2.5 py-1.5 shadow-sm flex items-center gap-1">
            ...
            {/* Floating card */}
            <div className="absolute -bottom-4 -left-4 bg-white border-2 border-blue-100 shadow-lg px-4 py-3 flex items-center gap-3 max-w-[180px]">
