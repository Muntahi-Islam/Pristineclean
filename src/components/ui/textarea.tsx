    ...
    return (
      <div className="space-y-1.5">
        ...
        <textarea
          id={id}
          className={cn(
            "flex min-h-[120px] w-full border-2 border-navy-200 bg-transparent px-4 py-3 text-navy-900 transition-all duration-200 placeholder:text-navy-400/60 hover:border-navy-300 focus-visible:border-blue-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/20 disabled:cursor-not-allowed disabled:opacity-50 resize-y",
